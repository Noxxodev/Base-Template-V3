...
function openAdminMenu()
    ...
    lib.registerContext({
        ...
        options = {
            ...
            {
                title = "Mes options",
                description = "Gérer vos options",
                icon = 'fa-solid fa-user',
                iconColor = '#0ada4c',
                onSelect = function(args)
                    TriggerEvent('noxxo:gestionoptions')
                end,
            },
            {
...
RegisterNetEvent('noxxo:gestionoptions')
AddEventHandler('noxxo:gestionoptions', function()
        ...
        options = {
            {
                ...
                iconColor = '#0a92da',
                onSelect = function(args)
                    ExecuteCommand("toggleNoClip")
                end,
            },
            {
                title = "Tp marker",
                description = "Ce téléporter au marker",
                ...
                onSelect = function(args)
                    ...
                    if DoesBlipExist(markerpoint) then
                        Citizen.CreateThread(function()
                            ...
                            ESX.ShowNotification("Vous avez été téléporté au marker", 'info')
                        end)
                    else
                        ESX.ShowNotification("Pas de marqueur sur la carte", 'info')
                    end
                end,
            },
        },
