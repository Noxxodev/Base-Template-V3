...
function putOnStretcher(toggle, target)
    ...
    TriggerServerEvent("ambulancejob:putOnStretcher", data)
    patientOnStretcher = toggle and target or nil
end

RegisterNetEvent("ambulancejob:togglePatientFromVehicle", function(veh)
    local playerPed = cache.ped or PlayerPedId()
...
RegisterNetEvent("ambulancejob:putOnStretcher", function(toggle)
    local playerPed = cache.ped or PlayerPedId()
    local playerCoords = cache.coords or GetEntityCoords(playerPed)
...
local function vehicleInteractions()
    local options = {
        {
            name = 'ambulancejob_take_stretcher',
        ...
        {
            name = 'ambulancejob_put_stretcher',
            icon = 'fa-solid fa-car-side',
        ...
        {
            name = 'ambulancejob_put_patient_in_vehicle',
            icon = 'fa-solid fa-car-side',
            ...
            fn = function(data)
                ...
                TriggerServerEvent('ambulancejob:togglePatientFromVehicle', dataToSend)
        ...
        {
            name = 'ambulancejob_take_patient_from_vehicle',
            icon = 'fa-solid fa-car-side',
...
local function stretcherInteraction()
    Target.addModel({ `prop_ld_binbag_01` }, {
        {
            name = 'ambulancejob_stretcher_model',
            label = locale('take_stretcher'),
        ...
        {
            name = 'ambulancejob_remove_from_stretcher',
            icon = 'fa-solid fa-car-side',
