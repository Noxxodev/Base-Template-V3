...
function stopPlayerDeath()
    ...
    TriggerServerEvent('ambulancejob:updateDeathStatus', deathStatus)
...
local function respawnPlayer()
    ...
    if removeItemsOnRespawn then
        TriggerServerEvent("ambulancejob:removeInventory")
    end
...
function onPlayerLoaded()
    ...
    local data = lib.callback.await('ambulancejob:getDeathStatus', false)
...
AddEventHandler('gameEventTriggered', function(event, data)
    ...
    if victimDiedAndPlayer then
        ...
        TriggerServerEvent('ambulancejob:updateDeathStatus', deathData)
