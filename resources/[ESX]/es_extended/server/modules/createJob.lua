...
local function generateNewJob2Table(name, label, grades)
    ...
    for _, v in pairs(grades) do
        job2.grades[tostring(v.grade)] = { job2_name = name, grade2 = v.grade, name = v.name, label = v.label, salary = v.salary, skin_male = v.skin_male or '{}', skin_female = v.skin_female or '{}' }
    end
